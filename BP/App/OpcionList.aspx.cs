...
namespace BP.App
{
    public partial class OpcionList : System.Web.UI.Page
    {
        ...
        {
            this.grdList.DataSource = OpcionManager.GetList(1);
        ...
        protected void grdList_RowCreated(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ImageButton delete = (ImageButton)e.Row.Cells[1].FindControl("im gDelete");
        ...
        protected void grdList_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editar")
            {
                ...
                url = "~/App/OpcionEdit.aspx?Id=" + this.grdList.SelectedDataKey["Codigo"].ToString();
